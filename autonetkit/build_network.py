...
# TODO: can remove the infrastructure now create g_ip seperately
    ...
    from autonetkit.design.mcast import build_mcast
    build_mcast(anm)

    from autonetkit.design.vxlan import build_vxlan
    build_vxlan(anm)

    from autonetkit.design.port_channel import build_pc
    build_pc(anm)
...
# post-processing
    ...
    from autonetkit.design.layer7 import build_snmp, build_ntp
    build_snmp(anm)
    build_ntp(anm)
