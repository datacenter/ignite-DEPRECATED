...
urlpatterns = patterns('',
    url(r'^/fabric/(?P<fid>[1-9][0-9]*)/switch/(?P<sid>[1-9][0-9]*)/config$',
        SwitchRunningConfigListView.as_view()),
    url(r'^/fabric/(?P<fid>[1-9][0-9]*)/switch/(?P<sid>[1-9][0-9]*)/config/(?P<id>[1-9][0-9]*)$',
        SwitchRunningConfigView.as_view()),
    url(r'^/fabric/(?P<fid>[1-9][0-9]*)/switch/(?P<sid>[1-9][0-9]*)/config/latest$',
        SwitchLatestRunningConfigView.as_view()),
    ...
    url(r'^/fabric/(?P<fid>[1-9][0-9]*)/switch/(?P<sid>[1-9][0-9]*)/resetbootdetail$',
        SwitchBootStatusResetView.as_view()),
    ...
    url(r'^/fabric/discovery$',
        FabricPostDiscoveryView.as_view()),
    url(r'^/fabric/discovery/(?P<id>[1-9][0-9]*)/save$',
        FabricSaveDiscoveryView.as_view()),
    url(r'^/fabric/discovery/(?P<id>[1-9][0-9]*)/delete$',
        FabricDeleteDiscoveryView.as_view()),
